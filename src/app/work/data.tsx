...
export const projects: Project[] = [
  {
    ...
    liveLink: "https://www.imagiccreation.lk/",

    introduction:
      "Imagic Creation is a growing production house specializing in videography, photography, and visual storytelling. As a creative brand, their work is highly visual, yet they lacked a strong digital platform to effectively showcase their capabilities.<br><br>This project focused on designing and developing an end-to-end website that not only reflects the brand’s cinematic identity but also improves content management and client conversion.<br><br>The solution combines a visually immersive interface with a scalable backend system using a headless CMS (Strapi), allowing the client to independently manage and update content without technical support.",
    problem:
    ...
    targetUsers:
      "<p>The website was designed for three primary user groups:</p><ul><li>Individuals looking for event coverage (weddings, personal shoots)</li><li>Businesses seeking commercial videography and photography services</li><li>Agencies & brands looking for creative collaboration</li></ul><br><p>Each user group required fast access to portfolio work and clear service understanding.</p>",
    
    wireframes:
      "Low-fidelity wireframes were created to define the core structure and user flow of the website before moving into high-fidelity design.<ul><p><b>Focus Areas</b></p><li>Designing a homepage with strong visual hierarchy and storytelling flow</li><li>Structuring a portfolio section for quick and intuitive browsing</li><li>Organizing service information in a clear and accessible format</li></ul><br><p>This stage helped validate layout decisions and ensure the structure supported both user experience and business goals before visual design began.</p>",
    uiDesign:
      "<p>The visual direction was designed to reflect the cinematic identity of Imagic Creation.</p><p><b>Design Approach</b></p>A dark cinematic theme was chosen to enhance the visual content and create a premium, film-like browsing experience.</p><br><p><b>Typography</b></p><ul><li>Space Grotesk was used for headings to create a modern visual identity, while Inter was used for body text to ensure clarity and readability across all devices</li><li>Strong typographic hierarchy to improve readability and scanning</li></ul><br><p><b>Layout</b></p><ul><li>Grid-based structure for consistent alignment</li><li>Large visual elements to emphasize portfolio work</li><li>Generous spacing to reduce cognitive load and clutter</li></ul>",
    designDecision:
      "<p>Throughout the design process, several key UX decisions were made:</p><ul><li>Prioritized visual content over heavy text to match user expectations in creative industries</li><li>Used whitespace strategically to guide user attention toward key content</li><li>Designed clear navigation to reduce friction in exploring projects and services</li><li>Maintained consistent UI patterns to improve usability and familiarity</li><li>Ensured full responsiveness across desktop and mobile devices</li></ul>",
    outcome:
      "<p>The final product is a modern, high-performance production house website that successfully combines visual storytelling with usability and scalability.</p><p>The website:</p><ul><li>Showcases Imagic Creation’s portfolio in a structured and engaging way</li><li>Strengthens brand identity through cinematic visual design</li><li>Improves navigation and overall user experience</li><li>Enables easy and efficient content management through Strapi CMS</li><li>Provides a fully responsive experience across all devices</li></ul>",
    learnings: 
      "<p>This project demonstrates my ability to:</p><ul><li>Design user-focused interfaces for real-world businesses</li><li>Translate brand identity into a digital experience</li><li>Balance aesthetics with usability and performance</li><li>Work across the full stack from UI design to development implementation</li></ul>",
  ...
  },
  {
    ...
    wireframes:
      "<p>Low-fidelity wireframes were created to define the structure and content hierarchy of the blog platform. The focus was on improving readability, simplifying navigation, and ensuring a distraction-free reading experience.</p><p>Key decisions made during this stage:</p><ul><li>Defined a clean article layout for better readability</li><li>Organized content into clear categories for easier navigation</li><li>Prioritized content-first design to reduce distractions</li><li>Structured publishing flow for easier content managemen</li></ul><br><p>This stage helped validate the information architecture before moving into high-fidelity UI design.</p>",
    uiDesign:
    ...
    outcome:
      "<p>The final design delivers a clean and structured blogging experience that improves readability, simplifies navigation, and enhances content management for the creator.</p><p>The platform successfully:</p><ul><li>Reduces complexity in the publishing workflow</li><li>Improves content discoverability through clear structure</li><li>Enhances reading experience with strong visual hierarchy</li><li>Provides a distraction-free interface for users</li><li>Enables easy content management through Strapi CMS</li></ul>",
    learnings:
      "<p>This project helped me understand how important simplicity is in content-heavy platforms. I learned how to balance user needs between content creation and content consumption while maintaining a clean and scalable design system.</p><p>I also improved my approach to designing CMS-driven interfaces and learned how structure directly impacts usability and readability.</p>",
