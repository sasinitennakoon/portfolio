...
export const projects: Project[] = [
  {
    ...
    introduction:
      "Imagic Creation is a growing production house specializing in videography, photography, and visual storytelling. As a creative brand, their work is highly visual, yet they lacked a strong digital platform to effectively showcase their capabilities.<br><br>This project involved end-to-end design and development of a modern portfolio website that reflects the brand’s cinematic style while ensuring a seamless and engaging user experience.<br><br>The focus was not only on aesthetics, but also on building a scalable and manageable system using a headless CMS, allowing the client to easily update and maintain their content.",
    problem:
